...
namespace SpoidaGamesArcadeLibrary.Resources.Entities
{
    public class BasketballManager
    {
        ...
        private static void LoadBasketballs(ContentManager content)
        {
            ...
            Basketball blueSlimeBall = new Basketball(content.Load<Texture2D>(@"Textures/Basketballs/BlueSlimeBall"), new List<Rectangle> { new Rectangle(0, 0, 96, 96) }, false, "Blue Slime Ball", 100000, ParticleEmitterTypes.BlueSlime);
            ...
            Basketball sawBlade = new Basketball(content.Load<Texture2D>(@"Textures/Basketballs/Saw"), new List<Rectangle> { new Rectangle(0, 0, 64, 64) }, false, "Sawvinguard", 2000000, ParticleEmitterTypes.None);
            Basketball distantStar = new Basketball(content.Load<Texture2D>(@"Textures/Basketballs/DistantStar"), new List<Rectangle> { new Rectangle(0, 0, 128, 128) }, false, "Distant Star", 3000000, ParticleEmitterTypes.BrightStar);
