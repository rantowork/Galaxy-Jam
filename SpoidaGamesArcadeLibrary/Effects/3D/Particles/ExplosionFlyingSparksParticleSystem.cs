...
namespace SpoidaGamesArcadeLibrary.Effects._3D.Particles
{
    public class ExplosionFlyingSparksParticleSystem : DefaultTexturedQuadTextureCoordinatesParticleSystem
    {
        ...
        readonly Rectangle m_sparkTextureCoordinates = new Rectangle(384, 445, 128, 13);
        private const float TEXTURE_ASPECT_RATIO = 13f / 128f;
        ...
        public void LoadEvents()
        {
            ...
            // Setup the emitter
            Emitter.PositionData.Position = new Vector3(67, 35, 0);
        ...
        public void InitializeParticleExplosion(DefaultTextureQuadTextureCoordinatesParticle particle)
        {
            ...
            particle.Height = ExplosionParticleSize * TEXTURE_ASPECT_RATIO;

            // Set the spark particle's texture coordinates
            particle.SetTextureCoordinates(m_sparkTextureCoordinates, Texture.Width, Texture.Height);
        }
        ...
        public void Explode()
        {
            Emitter.BurstParticles = ExplosionIntensity;
        }
